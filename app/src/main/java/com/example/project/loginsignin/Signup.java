...
public class Signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        semestertb = findViewById(R.id.semestertb);
        ...
        semestertb.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        SignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Signup.this, "Please Select semester", Toast.LENGTH_SHORT).show();
                }else {
                    SignUpUser(v);
                }
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    //DataInsert
                    SignUp.setEnabled(true);
                    Users users = new Users(d1, d2, d3, d4, d5,d6);
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            Toast.makeText(Signup.this, "Registered Sucessfully Please Check Your Email for Registered", Toast.LENGTH_SHORT).show();
