...
public class addTeachers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profession = findViewById(R.id.course2);
        ...
        list = new ArrayList<>();
        list.add(0, "Select Teacher Profession");
        list.add("Computer");
        list.add("Biology");
        list.add("Physics");
        list.add("History");
        ...
        SignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(item)) {
                    Toast.makeText(addTeachers.this, "Please Select Profession", Toast.LENGTH_SHORT).show();
                } else {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    //DataInsert
                    SignUp.setEnabled(true);
                    teachers users = new teachers(d1, d2, d3, d4, d5, d6);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(addTeachers.this, "Registered SucessFully", Toast.LENGTH_SHORT).show();
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            Toast.makeText(addTeachers.this, "Registered Sucessfully Please Check Your Email for Registered", Toast.LENGTH_SHORT).show();
                                                            ...
                                                            loadingbar.dismiss();
                                                            Toast.makeText(addTeachers.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
